        ...
        messages: [
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Ты опытный сметчик в России. Проанализируй этот строительный чертёж или фото объекта. Составь подробную смету в рублях по актуальным рыночным ценам 2024 года. Верни ТОЛЬКО валидный JSON без markdown и комментариев: {"summary":"краткое описание объекта","items":[{"name":"наименование","unit":"ед.","qty":0,"price":0,"total":0}],"total_rub":0,"notes":"замечания"}',
              },
              {
                type: 'image_url',
                image_url: {
