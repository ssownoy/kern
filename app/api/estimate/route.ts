...
5. Разбей смету на разделы: Земляные работы, Фундамент, Стены и перекрытия, Кровля, Отделочные работы, Инженерные системы, Прочие работы. Используй только те разделы которые есть на чертеже.
  ...
  "sections": [
    {
      ...
      "section_total": сумма раздела
    }
  ],
  "total_rub": сумма всех разделов,
